...
from .api.routes import auth, books, test_sessions, analytics, goals, planner, academic, social, telegram, dashboard, review, progress, student_state
...
app.include_router(student_state.router, prefix="/api")
